...
public class Consultar_motor extends javax.swing.JFrame /*implements ActionListener*/ {
    ...
    private void initComponents() {
        ...
        setTitle("CONSULTAR TIPO MOTOR");
        setMinimumSize(new java.awt.Dimension(670, 450));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel9.setText("RACAD AUTOMOTRIZ - CONSULTAR TIPO MOTOR");
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_motor.class
...
.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consultar_motor().setVisible(true);
            }
        });
    }
