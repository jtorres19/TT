...
public class Orden_trabajo2 extends javax.swing.JFrame {
    ...
    private String[] getColumnas() {
        String columna[] = new String[]{"CODIGO", "FECHA PRESUPUESTO", "PATENTE"};
        return columna;
    }
    ...
    private void setFilas() {
        try {
            ...
            ResultSet lista = sentencia.executeQuery("SELECT cod_colicitud, fecha_presupuesto, patente "
    ...
    void llenarTabla() {
        int solicitud = Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
    }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(LBL_folio, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(LBL_folio1, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (verificar() == 0) {
            String pat = jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString();
            String rut = jTable7.getValueAt(jTable7.getSelectedRow(), 0).toString();
            String fecha = jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString();
            int dis;
            int fol = 0;
            String fechaactual = lblFecha.getText();
            String obser = JTA_observaciones.getText().toUpperCase().trim();
            int cod = 0;
            ...
            String sql = "INSERT INTO solicitud_servicio(cod_solicitud,observaciones,subtotal,total,fecha_presupuesto,fecha_orden,estado_solicitud,patente,rut_trabajador) "
                    + "VALUES(" + cod + ",'" + obser + "'," + total + "," + total + ",'" + fecha + "','" + fechaactual + "','" + est + "','" + pat + "','" + rut + "')";
            ...
            while (i < columna &&  j < columna2) {
                ...
                String sql2 = "INSERT INTO detalle_solicitud(cod_solicitud,cod_item,id_servicio,precio,valor_venta,cantidad,observaciones,fecha_presupueto,fecha_orden,rut_trabajador) "
                        + "VALUES(" + cod + "," + item + "," + servicio + "," + precio + "," + venta + "," + cantidad + ",'" + obser + "','" + fecha + "','" + fechaactual + "','" + rut + "')";
