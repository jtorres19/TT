...
public class Consultar_marca extends javax.swing.JFrame /*implements ActionListener*/ {
    ...
    private void initComponents() {
        ...
        setTitle("CONSULTAR MARCA VEHICULO");
        setMinimumSize(new java.awt.Dimension(670, 450));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel9.setText("RACAD AUTOMOTRIZ - CONSULTAR MARCA VEHICULO");
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_marca.class
...
.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consultar_marca().setVisible(true);
            }
        });
    }
