...
public class Ingresar_tipovehiculo extends javax.swing.JFrame {
    ...
    private String[] getColumnas() {
        ...
        String columna[] = new String[]{"ID VEHÍCULO", "NOMBRE"};
    ...
    public int verificar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (nombre.equals(nom)) {
                    ...
                    "ERROR, Ya existe este TIPO VEHICULO!", "ERROR",
        ...
        if (nombre.equals("")) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Error, TIPO VEHICULO maximo 15 letras", "ERROR",
                    JOptionPane.ERROR_MESSAGE);
            cont++;
        }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("INGRESAR TIPO VEHÍCULO");

        jLabel4.setText("Nombre Tipo Vehículo :");
        ...
        JB_OK.setText("\uD83D\uDDAB");
        JB_OK.setToolTipText("Ingresar Tipo Vehiculo");
    ...
    private void JB_OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_OKActionPerformed
        if (verificar() == 0) {
            ...
            String sql = "INSERT INTO tipo_vehiculo(id_tipo_vehiculo,nombre) VALUES(" + tipo + ",'" + nom + "')";
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ingresar_tipovehiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ingresar_tipovehiculo().setVisible(true);
            }
        });
    }
