...
public class Eliminar_tipovehiculo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("ELIMINAR TIPO VEHICULO");
        setMinimumSize(new java.awt.Dimension(420, 210));
        setResizable(false);

        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel9.setText("RACAD AUTOMOTRIZ - ELIMINAR TIPO VEHICULO");
    ...
    private void BTN_DelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_DelActionPerformed
        ...
        try {
            ...
            msj = "Error al buscar TIPO VEHICULO en tabla?";
        ...
        if (verificar() == 0 && i == 0) {
            ...
            try {
                ...
                LBL_estado.setText("TIPO VEHICULO borrada con éxito");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eliminar_tipovehiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Eliminar_tipovehiculo().setVisible(true);
            }
        });
    }
