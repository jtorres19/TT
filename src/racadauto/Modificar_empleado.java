...
public class Modificar_empleado extends javax.swing.JFrame {
    ...
    public void filtroPaterno() {
        ...
        filtro = JT_bpaterno.getText().toUpperCase();
        int columna = 2;
        trsfiltro.setRowFilter(RowFilter.regexFilter(JT_bpaterno.getText().toUpperCase(), columna));
    }

    public void filtroMaterno() {

        filtro = JT_bmaterno.getText().toUpperCase();
        int columna = 3;
        trsfiltro.setRowFilter(RowFilter.regexFilter(JT_bmaterno.getText().toUpperCase(), columna));
    }
    ...
    private void initComponents() {
        ...
        JT_bpaterno = new javax.swing.JTextField();
        JT_bmaterno = new javax.swing.JTextField();
        ...
        JT_bpaterno.setFont(new java.awt.Font("Tahoma", 2, 11)); // NOI18N
        JT_bpaterno.setForeground(new java.awt.Color(153, 153, 153));
        JT_bpaterno.setText("Buscar por paterno");
        JT_bpaterno.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                JT_bpaternoFocusLost(evt);
            }
        });
        JT_bpaterno.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                JT_bpaternoMouseClicked(evt);
            }
        });
        JT_bpaterno.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                JT_bpaternoKeyTyped(evt);
            }
        });

        JT_bmaterno.setFont(new java.awt.Font("Tahoma", 2, 11)); // NOI18N
        JT_bmaterno.setForeground(new java.awt.Color(153, 153, 153));
        JT_bmaterno.setText("Buscar por materno");
        JT_bmaterno.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                JT_bmaternoFocusLost(evt);
            }
        });
        JT_bmaterno.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                JT_bmaternoMouseClicked(evt);
            }
        });
        JT_bmaterno.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                JT_bmaternoKeyTyped(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(32, 32, 32)
                .addComponent(JT_rut, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(JT_nombre, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(45, 45, 45)
                .addComponent(JT_bpaterno, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(JT_bmaterno, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void JT_bpaternoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_JT_bpaternoFocusLost
        JT_bpaterno.setFont(new java.awt.Font("Tahoma",2,11));
        JT_bpaterno.setForeground(new java.awt.Color(153,153,153));
        JT_bpaterno.setText("Buscar por paterno");
    }//GEN-LAST:event_JT_bpaternoFocusLost

    private void JT_bpaternoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JT_bpaternoMouseClicked
        JT_bpaterno.setText("");
        JT_bpaterno.setFont(new java.awt.Font("Tahoma",0,11));
        JT_bpaterno.setForeground(new java.awt.Color(0,0,0));
    }//GEN-LAST:event_JT_bpaternoMouseClicked

    private void JT_bpaternoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JT_bpaternoKeyTyped
        JT_bpaterno.addKeyListener(new KeyAdapter() {
            public void keyReleased(final KeyEvent e) {
                filtroPaterno();
            }
        });
        trsfiltro = new TableRowSorter(modeloTabla);
        jTable1.setRowSorter(trsfiltro);
    }//GEN-LAST:event_JT_bpaternoKeyTyped

    private void JT_bmaternoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_JT_bmaternoFocusLost
        JT_bmaterno.setFont(new java.awt.Font("Tahoma",2,11));
        JT_bmaterno.setForeground(new java.awt.Color(153,153,153));
        JT_bmaterno.setText("Buscar por materno");
    }//GEN-LAST:event_JT_bmaternoFocusLost

    private void JT_bmaternoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JT_bmaternoMouseClicked
        JT_bmaterno.setText("");
        JT_bmaterno.setFont(new java.awt.Font("Tahoma",0,11));
        JT_bmaterno.setForeground(new java.awt.Color(0,0,0));
    }//GEN-LAST:event_JT_bmaternoMouseClicked

    private void JT_bmaternoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JT_bmaternoKeyTyped
        JT_bmaterno.addKeyListener(new KeyAdapter() {
            public void keyReleased(final KeyEvent e) {
                filtroMaterno();
            }
        });
        trsfiltro = new TableRowSorter(modeloTabla);
        jTable1.setRowSorter(trsfiltro);
    }//GEN-LAST:event_JT_bmaternoKeyTyped
    ...
    private javax.swing.JTextField JT_bmaterno;
    private javax.swing.JTextField JT_bpaterno;
