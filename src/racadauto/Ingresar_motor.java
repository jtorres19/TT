...
public class Ingresar_motor extends javax.swing.JFrame {
    ...
    public int verificar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (nombre.equals(nom)) {
                    ...
                    "ERROR, Ya existe este MOTOR!", "ERROR",
        ...
        if (nombre.equals("")) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Error, MOTOR maximo 15 letras", "ERROR",
                    JOptionPane.ERROR_MESSAGE);
            cont++;
        }
    ...
    private void initComponents() {
        ...
        setTitle("INGRESAR TIPO MOTOR");
        setMinimumSize(new java.awt.Dimension(300, 300));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel9.setText("INGRESAR TIPO MOTOR");

        jLabel4.setText("Nombre Tipo Motor:");
        ...
        JB_OK.setText("\uD83D\uDDAB");
        JB_OK.setToolTipText("Ingresar Tipo Motor");
    ...
    private void JB_OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_OKActionPerformed
        if (verificar() == 0) {
            ...
            String sql = "INSERT INTO tipo_motor(id_tipo_motor,nombre) VALUES(" + motor + ",'" + nom + "')";
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ingresar_motor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ingresar_motor().setVisible(true);
            }
        });
    }
