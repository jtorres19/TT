...
public class Consultar_combustible extends javax.swing.JFrame /*implements ActionListener*/ {
    ...
    private String[] getColumnas() {
        ...
        String columna[] = new String[]{"ID TIPO COMBUSTIBLE", "NOMBRE"};
    ...
    private void initComponents() {
        ...
        setTitle("CONSULTAR TIPO COMBUSTIBLE");
        setMinimumSize(new java.awt.Dimension(670, 450));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel9.setText("RACAD AUTOMOTRIZ - CONSULTAR TIPO COMBUSTIBLE");
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_combustible.class
...
.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consultar_combustible().setVisible(true);
            }
        });
    }
