...
public class Ingresar_combustible extends javax.swing.JFrame {
    ...
    public int verificar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (nombre.equals(nom)) {
                    ...
                    "ERROR, Ya existe este TIPO COMBUSTIBLE!", "ERROR",
        ...
        if (nombre.equals("")) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Error, TIPO COMBUSTIBLE maximo 15 letras", "ERROR",
                    JOptionPane.ERROR_MESSAGE);
            cont++;
        }
    ...
    private void initComponents() {
        ...
        setTitle("INGRESAR TIPO COMBUSTIBLE");
        setMinimumSize(new java.awt.Dimension(300, 300));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel9.setText("INGRESAR TIPO COMBUSTIBLE");

        jLabel4.setText("Nombre Tipo Combustible :");
        ...
        JB_OK.setText("\uD83D\uDDAB");
        JB_OK.setToolTipText("Ingresar Combustible");
    ...
    private void JB_OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_OKActionPerformed
        ...
        if (verificar() == 0) {
            ...
            try {
                ...
                msj = "Error con TIPO COMBUSTIBLE";
            }

            String sql = "INSERT INTO tipo_combustible(id_tipo_combustible,nombre) VALUES(" + combustible + ",'" + nom + "')";
            try {
                ...
                JOptionPane.showMessageDialog(null,
                    "Tipo Combustible NO Ingresado, BD", "ERROR",
                    JOptionPane.ERROR_MESSAGE);
            ...
            if (dis == 1) {
                ...
                JOptionPane.showMessageDialog(null,
                    "Tipo Combustible NO Ingresado", "ERROR",
                    JOptionPane.ERROR_MESSAGE);
    ...
    private void JT_nomKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JT_nomKeyTyped
        ...
        if (!Character.isLetter(validar) && validar != evt.VK_SPACE && validar != evt.VK_BACK_SPACE) {
            ...
            JOptionPane.showMessageDialog(null,
                    "ERROR, TIPO COMBUSTIBLE solo pueden ser letras", "ERROR",
                    JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ingresar_combustible.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ingresar_combustible().setVisible(true);
            }
        });
    }
