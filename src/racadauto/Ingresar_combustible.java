...
public class Ingresar_combustible extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("RACAD AUTOMOTRIZ - INGRESAR TIPO COMBUSTIBLE");
    ...
    private void JB_OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_OKActionPerformed
        ...
        if (verificar() == 0) {
            ...
            try {
                ...
                msj = "TIPO COMBUSTIBLE no ingresada, Problemas en base de datos";
                LBL_estado.setText(msj);
                dis = 0;
            }
            if (dis == 1) {
            ...
            msj = "TIPO COMBUSTIBLE no Ingresada";
            LBL_estado.setText(msj);
        }
