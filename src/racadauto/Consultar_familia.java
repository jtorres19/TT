...
public class Consultar_familia extends javax.swing.JFrame /*implements ActionListener*/ {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("RACAD AUTOMOTRIZ - CONSULTAR FAMILIA");
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_familia.class
...
.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consultar_familia().setVisible(true);
            }
        });
    }
